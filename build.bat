...
%THISDIR%\nuget.exe install boost-vc140 -Version 1.69.0
...
call :find-files-64 %PACKAGE% "*zlib*.dll"
call :find-files-64 %PACKAGE% "*zlib*.lib"

call :find-files-64 %PACKAGE% "*bzip2*.dll"
call :find-files-64 %PACKAGE% "*bzip2*.lib"
...
call :find-files-32 %PACKAGE% "*zlib*.dll"
call :find-files-32 %PACKAGE% "*zlib*.lib"

call :find-files-32 %PACKAGE% "*bzip2*.dll"
call :find-files-32 %PACKAGE% "*bzip2*.lib"
